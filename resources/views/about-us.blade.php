...
@section("main")
    ...
    <section>
        <h2>¿Qué es Petfy?</h2>
        <p>Petfy es una plataforma cuyo objetivo consiste en colaborar con refugios cántabros en la adopción de mascotas.
            Además tratamos de transmitir nuestro respeto y amor por los animales -nuestros valores en definitiva- de
    ...
    <section>
        ...
        <p>La misión será sacar de los refugios al máximo número de mascotas posible y darles una familia que les cuiden.</p>
