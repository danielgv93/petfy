    ...
    <div class="mb-5">
        <table class="table table-striped table-hover">
            ...
            @foreach ($adopciones as $adopcion)
                <tr class="text-center">
                    <td>
                        <a href="{{ route('familia-historial.show' , $adopcion["familia"]) }}">{{$adopcion["familia"]->name}}</a>
                    </td>
                    <td>
                        <a href="{{ route('mascotas.show' , $adopcion["mascota"]) }}">{{$adopcion["mascota"]->nombre}} {!! $adopcion["mascota"]->especie->especie === "Perro" ? '<i class="fas fa-dog"></i>' : '<i class="fas fa-cat"></i>' !!}</a>
                    </td>
